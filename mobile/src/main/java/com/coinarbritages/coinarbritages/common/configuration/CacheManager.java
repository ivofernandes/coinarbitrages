...
public class CacheManager {
    ...
    public static final String PREFERENCE_SETTINGS_ETH_BUY_KRAKEN_SELL_GDAX = "SETTINGS_ETH_BUY_KRAKEN_SELL_GDAX";
    public static final String PREFERENCE_SETTINGS_ETH_BUY_GDAX_SELL_KRAKEN = "SETTINGS_ETH_BUY_GDAX_SELL_KRAKEN";

    public static final String PREFERENCE_SETTINGS_BTC_BUY_KRAKEN_SELL_GDAX = "SETTINGS_BTC_BUY_KRAKEN_SELL_GDAX";
    public static final String PREFERENCE_SETTINGS_BTC_BUY_GDAX_SELL_KRAKEN = "SETTINGS_BTC_BUY_GDAX_SELL_KRAKEN";

    public static final String PREFERENCE_SETTINGS_LTC_BUY_KRAKEN_SELL_GDAX = "SETTINGS_LTC_BUY_KRAKEN_SELL_GDAX";
    public static final String PREFERENCE_SETTINGS_LTC_BUY_GDAX_SELL_KRAKEN = "SETTINGS_LTC_BUY_GDAX_SELL_KRAKEN";
